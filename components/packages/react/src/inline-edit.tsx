...
export interface InlineEditProps extends Omit<HTMLAttributes<HTMLButtonElement>, "onChange"> {
 ...
 */
export const InlineEdit = forwardRef<HTMLButtonElement, InlineEditProps>(function InlineEdit(
  ...
  if (editing) {
    return (
      <input
        aria-label={label}
        className="td-inline-edit-input td-react-inline-edit-input"
        value={draft}
        autoFocus
  ...
  return (
    <button
      ...
      className={cx("td-inline-edit", "td-react-inline-edit", className)}
      onClick={start}
    >
