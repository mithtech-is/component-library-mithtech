...
export interface PopoverProps extends Omit<HTMLAttributes<HTMLDivElement>, "title"> {
   ...
   * This is the button's *contents*, not the button: Popover renders the button
...
export const Popover = forwardRef<HTMLDivElement, PopoverProps>(function Popover(
  ...
  return (
    <div
      {...props}
      ref={setRef}
      className={cx("td-popover-wrap", "td-react-popover-wrap", className)}
    ...
    >
      <button
        ref={triggerRef}
        type="button"
        className={cx("td-react-popover-trigger", triggerClassName)}
      ...
      <div
        ...
        aria-hidden={!isOpen}
        className="td-popover td-react-popover"
      >
        {title ? (
