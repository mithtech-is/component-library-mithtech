...
export type GaugeLoad = "low" | "med" | "high";
...
const bandFor = (value: number): GaugeLoad => (value <= 33 ? "low" : value <= 66 ? "med" : "high");
...
export const Gauge = forwardRef<HTMLDivElement, GaugeProps>(function Gauge(
  ...
  const band = load ?? bandFor(clamped);
  ...
  return (
    <div
      ...
      data-load={band}
      className={cx("td-gauge", "td-react-gauge", className)}
    >
