 ...
 */
export type ProfileCardLayout = "row" | "stack";
...
export interface ProfileCardProps extends Omit<HTMLAttributes<HTMLElement>, "title" | "role"> {
  name: ReactNode;
 ...
 */
export const ProfileCard = forwardRef<HTMLElement, ProfileCardProps>(function ProfileCard(
