...
export interface UndoBarProps extends HTMLAttributes<HTMLDivElement> {
 ...
 */
export const UndoBar = forwardRef<HTMLDivElement, UndoBarProps>(function UndoBar(
  ...
  return (
    <div
      ...
      ref={ref}
      role="status"
      className={cx("td-undobar", "td-react-undobar", className)}
