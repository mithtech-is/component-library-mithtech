...
export const Testimonial = forwardRef<HTMLElement, TestimonialProps>(function Testimonial(
  ...
  return (
    <figure {...props} ref={ref} className={cx("td-react-testimonial", className)}>
      <blockquote className="td-react-testimonial-quote" cite={source}>
        {children}
      </blockquote>
      <figcaption className="td-react-testimonial-meta">
        {avatar ?? (initials ? <span className="td-react-testimonial-avatar" aria-hidden="true">{initials}</span> : null)}
        <span className="td-react-testimonial-who">
          <span className="td-react-testimonial-name">{name}</span>
          {role !== undefined ? <span className="td-react-testimonial-role">{role}</span> : null}
        </span>
      </figcaption>
    </figure>
  );
...
export interface TestimonialGridProps extends HTMLAttributes<HTMLDivElement> {
 ...
 */
export const TestimonialGrid = forwardRef<HTMLDivElement, TestimonialGridProps>(function TestimonialGrid(
  ...
  return (
    <div
      {...props}
      ref={ref}
      className={cx("td-react-testimonial-grid", className)}
