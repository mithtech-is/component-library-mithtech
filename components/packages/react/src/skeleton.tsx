 ...
 *
 * Give it the measure of what is coming. A placeholder that is the wrong size
...
export const Skeleton = forwardRef<HTMLDivElement, SkeletonProps>(function Skeleton(
  ...
  return (
    <div
      ...
      className={cx("td-react-skeleton", className)}
      style={{ ...style, width: size(width), height: shape === "text" ? undefined : size(height) } as CSSProperties}
    >
      {Array.from({ length: bars }, (_, i) => (
        <span
          key={i}
          aria-hidden="true"
          className="td-react-skeleton-bar"
