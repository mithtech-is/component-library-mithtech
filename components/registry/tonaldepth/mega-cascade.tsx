 ...
 * `<TonalDepthMegaCascade groups={SERVICES} />` on the bar and
 * `sections: TonalDepthmegaCascadeSections(SERVICES)` in the drawer, and a category
 ...
 */
export function TonalDepthmegaCascadeSections(
  groups: TonalDepthMegaCascadeGroup[],
  seeAllLabel?: (branch: TonalDepthMegaCascadeBranch) => ReactNode,
): TonalDepthMegaSection[] {
