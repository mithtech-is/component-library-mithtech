...
import "./tonaldepth-spinner.css";

function cx(...values: Array<string | false | null | undefined>): string {
  return values.filter(Boolean).join(" ");
}

export interface TonalDepthSpinnerProps extends HTMLAttributes<HTMLSpanElement> {
 ...
 */
export const TonalDepthSpinner = forwardRef<HTMLSpanElement, TonalDepthSpinnerProps>(function TonalDepthSpinner(
  ...
  return (
    <span
      ...
      role="status"
      aria-label={label}
      className={cx("td-spinner", "td-registry-spinner", className)}
