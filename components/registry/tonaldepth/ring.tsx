...
import "./tonaldepth-ring.css";

function cx(...values: Array<string | false | null | undefined>): string {
  return values.filter(Boolean).join(" ");
}

export type TonalDepthRingTone = "brand" | "accent" | "green" | "error";

export interface TonalDepthRingProps extends HTMLAttributes<HTMLDivElement> {
 ...
 */
export const TonalDepthRing = forwardRef<HTMLDivElement, TonalDepthRingProps>(function TonalDepthRing(
  ...
  return (
    <div
      ...
      aria-label={label}
      data-tone={tone}
      className={cx("td-ring", "td-registry-ring", className)}
