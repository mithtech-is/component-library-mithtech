...
const TABLES = {
  ...
  "popover": ["popover", "PopoverProps", "Popover"],
  "gauge": ["gauge", "GaugeProps", "Gauge"],
  "uptime": ["uptime", "UptimeBarsProps", "UptimeBars"],
  "undobar": ["undobar", "UndoBarProps", "UndoBar"],
  "inline-edit": ["inline-edit", "InlineEditProps", "InlineEdit"],
  "carousel": ["carousel", "CarouselProps", "Carousel"],
